...
const A = [2, 5, 4, 7, 10, 3];
const B = [4, 6, 8, 11, 28, 2];
const merged_arr = A.concat(B); //Merge A and B arrays
const merged_Arr = merged_arr.sort((a, b) => a - b); //sort the arrays using comparison function
//Calling median function
const median = findMedian(merged_Arr);
//calculate median
...
console.log(median);
function findMedian(merged_Arr) {
